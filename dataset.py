...
def cifar10_loader(args):
    ...
    train_dataset = datasets.CIFAR10(root='/home/hhjung/hhjung/cifar10/',
                                     train=True,
                                     transform=transform_train,
                                     download=True)

    test_dataset = datasets.CIFAR10(root='/home/hhjung/hhjung/cifar10/',
                                    train=False,
                                    transform=transform_test)
...
def cifar100_loader():
    ...
    train_dataset = datasets.CIFAR100(root='/home/hhjung/hhjung/cifar100/',
                                     train=True,
                                     transform=transform_train,
                                     download=True)

    test_dataset = datasets.CIFAR100(root='/home/hhjung/hhjung/cifar100/',
                                    train=False,
                                    transform=transform_test)
